...
export default defineComponent({
  ...
  setup(props: { amountX: number; amountY: number; color: any; top: any }) {
    ...
    //监听鼠标移动事件
    function onPointerMove(event: { isPrimary: boolean; clientX: number }) {
...
#iviewBg {
  width: 100%;
  height: 100vh;
  background: url("../assets/img/wavesBg.png") no-repeat;
  overflow: hidden;
}
</style>
